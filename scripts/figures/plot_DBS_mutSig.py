# 07-21-2025
# plotting of mutational signatures from generated DBS mutational matricies
...
matrix_path=args.top_dir + "/" + args.sample_dir + "/final_filtered/output/DBS/"
...
# plotting DBS78
sigPlot.plotDBS((matrix_path + id_final + ".DBS78.all"), (out_path + "percent/DBS78/"), id_final, "78", percentage=True)

sigPlot.plotDBS((matrix_path + id_final + ".DBS78.all"), (out_path + "counts/DBS78/"), id_final, "78", percentage=False)
